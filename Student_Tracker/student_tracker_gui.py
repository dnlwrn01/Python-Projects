...
def load_gui(self):
    ...
    #define the listbox w/ scrollbar and grid them
    ...
    self.btn_add = tk.Button(self.master, width = 5, height =1, text = 'Submit', command = lambda: student_tracker_func.addToList(self))
    self.btn_add.grid(row = 9, column = 2, pady=(0,60), padx=(0,0) ,sticky = E)
    self.btn_add = tk.Button(self.master, width = 5, height =1, text = 'Delete', command = lambda: student_tracker_func.onDelete(self))
    self.btn_add.grid(row = 9, column = 2, pady=(0,60), padx=(0,60) ,sticky = E)
    self.btn_close = tk.Button(self.master, width = 5, height = 1, text = 'Close', command = lambda: student_tracker_func.ask_quit(self))
    self.btn_close.grid(row =9, column = 2, pady=(0,60), padx=(0,120), sticky = E)
